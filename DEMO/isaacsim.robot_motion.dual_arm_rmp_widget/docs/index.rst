...
.. _ext_isaacsim_robot_motion_dual_arm_rmp_widget:
...
[isaacsim.robot_motion.dual_arm_rmp_widget] Dual Arm RmpFlow Dashboard
#######################################################################
...
Real-time dual arm RMPflow reactive obstacle avoidance control dashboard
...
.. tab-set::
    .. tab-item:: Command-line interface
        ...
        .. code-block:: bash
            ...
            APP_SCRIPT.(sh|bat) --enable isaacsim.robot_motion.dual_arm_rmp_widget
    ...
    .. tab-item:: Experience/extension configuration
        ...
        .. code-block:: ini
            ...
            [dependencies]
            "isaacsim.robot_motion.dual_arm_rmp_widget" = {}

    .. tab-item:: Extension Manager UI
        :sync: tab_gui

        Open the *Window > Extensions* menu in a running application instance and search for ``isaacsim.robot_motion.dual_arm_rmp_widget``.
