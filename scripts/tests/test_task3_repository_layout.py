...
EXPECTED_TASK3_PATHS = (
    ...
    "task3_isaacsim/deprecated/scene_robot_room_rmpflow.py",
    "task3_isaacsim/deprecated/common/dual_arm_lula.py",
    "task3_isaacsim/deprecated/common/keyboard_arm_teleop.py",
    "task3_isaacsim/deprecated/common/teleop_commands.py",
    "task3_isaacsim/deprecated/common/teleop_targets.py",
