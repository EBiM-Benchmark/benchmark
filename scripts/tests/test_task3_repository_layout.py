...
EXPECTED_TASK3_PATHS = (
    ...
    "task3_isaacsim/deprecated/scripts/scene_robot_room_rmpflow.py",
    "task3_isaacsim/deprecated/scripts/common/dual_arm_lula.py",
    "task3_isaacsim/deprecated/scripts/common/keyboard_arm_teleop.py",
    "task3_isaacsim/deprecated/scripts/common/teleop_commands.py",
    "task3_isaacsim/deprecated/scripts/common/teleop_targets.py",
    "task3_isaacsim/tests/test_gripper_profiles.py",
    "task3_isaacsim/tests/test_launcher.py",
    "task3_isaacsim/deprecated/tests/test_dual_arm_lula.py",
    "task3_isaacsim/deprecated/tests/test_keyboard_arm_teleop.py",
    "task3_isaacsim/deprecated/tests/test_scene_robot_room_rmpflow.py",
    "task3_isaacsim/deprecated/tests/test_teleop_commands.py",
    "task3_isaacsim/deprecated/tests/test_teleop_targets.py",
